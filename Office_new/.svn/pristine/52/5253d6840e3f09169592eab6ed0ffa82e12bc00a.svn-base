...
@interface CSSMeetingRTSManager()<NIMRTSConferenceManagerDelegate>

@property (nonatomic, strong) NIMRTSConference  *currentConference;

@end

@implementation CSSMeetingRTSManager
...
- (NSError *)joinConference:(NSString *)name
{
    ...
    NIMRTSConference *conference = [[NIMRTSConference alloc] init];
    conference.name = name;
    conference.serverRecording = [[CSSBundleSetting sharedConfig] serverRecordWhiteboardData];
