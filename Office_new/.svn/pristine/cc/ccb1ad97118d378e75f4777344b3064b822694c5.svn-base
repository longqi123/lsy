...
@class CSSTimerHolder;

@protocol CSSTimerHolderDelegate <NSObject>
- (void)onNTESTimerFired:(CSSTimerHolder *)holder;
@end

@interface CSSTimerHolder : NSObject
@property (nonatomic,weak)  id<CSSTimerHolderDelegate>  timerDelegate;

- (void)startTimer:(NSTimeInterval)seconds
          delegate:(id<CSSTimerHolderDelegate>)delegate
