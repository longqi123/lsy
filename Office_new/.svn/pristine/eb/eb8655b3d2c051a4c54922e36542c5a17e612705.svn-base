...
@class CSKitTimerHolder;

@protocol CSKitTimerHolderDelegate <NSObject>
- (void)onNIMKitTimerFired:(CSKitTimerHolder *)holder;
@end

@interface CSKitTimerHolder : NSObject
@property (nonatomic,weak)  id<CSKitTimerHolderDelegate>  timerDelegate;

- (void)startTimer:(NSTimeInterval)seconds
          delegate:(id<CSKitTimerHolderDelegate>)delegate
