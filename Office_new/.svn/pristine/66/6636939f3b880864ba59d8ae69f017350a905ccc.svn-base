...
+ (UIImage *)fetchChartlet:(NSString *)imageName chartletId:(NSString *)chartletId{
    ...
    NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"CSKitResouce" ofType:@"bundle"];
...
{
    CGFloat pixels = [[CSSDevice currentDevice] suggestImagePixels];
