...
@interface CSSPageScrollView : UIScrollView

@end

@interface CSSPageView ()
{
...
- (void)setupControls
{
    if (_scrollView == nil)
    {
        _scrollView = [[CSSPageScrollView alloc]initWithFrame:self.bounds];
...
@implementation CSSPageScrollView
