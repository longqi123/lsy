...
@interface CSSessionViewController : UIViewController<CSInputActionDelegate,CSMessageCellDelegate,CSSessionMsgDatasourceDelegate,NIMChatManagerDelegate>
...
@property (nonatomic, strong, readonly) CSSessionViewLayoutManager *layoutManager;

@property (nonatomic, strong) CSInputView *sessionInputView;
