//
//  MessgeOrganizationViewController4.swift
//  Office
//
...
class MessgeOrganizationViewController4: UIViewController {
...
extension MessgeOrganizationViewController4{
    func creatUI() {
        ...
        Network.post(parameter: para, success: { (json) in
            ...
            if json["result"]["Fenye"].count > 0{//跳转好友列表
                ...
                if data.count > 0{
                    ...
                    vc.comeFrome = "MessgeOrganizationViewController3"
...
extension MessgeOrganizationViewController4: UITableViewDelegate,UITableViewDataSource{
