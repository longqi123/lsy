...
@implementation CSVideoContentConfig
- (CGSize)contentSize:(CGFloat)cellWidth
{
    ...
    if (!CGSizeEqualToSize(videoObject.coverSize, CGSizeZero)) {
        //有封面就直接拿封面大小
        contentSize = [UIImage cs_sizeWithImageOriginSize:videoObject.coverSize
...
{
    return @"CSSessionVideoContentView";
}
