...
@interface CSSChatroomListCellInfoView : UIView
- (void)refresh:(id)data;
@end

@interface CSSChatroomListCell()

@property (nonatomic,strong) UIImageView *coverImageView;

@property (nonatomic,strong) CSSChatroomListCellInfoView *infoView;

@end

@implementation CSSChatroomListCell
...
- (CSSChatroomListCellInfoView *)infoView{
    if (!_infoView) {
        _infoView = [[CSSChatroomListCellInfoView alloc] initWithFrame:CGRectMake(0, 0, self.width, 44)];
...
@interface CSSChatroomListCellInfoView()
...
@implementation CSSChatroomListCellInfoView
