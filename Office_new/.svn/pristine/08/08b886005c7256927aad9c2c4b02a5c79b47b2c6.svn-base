//
//  MessgeOrganizationViewController2.swift
//  Office
//
...
class MessgeOrganizationViewController2: UIViewController {
...
extension MessgeOrganizationViewController2{
    func creatUI() {
        ...
        Network.post(parameter: para, success: { (json) in
            ...
            if json["result"]["Fenye"].count > 0{//跳转好友列表
                ...
                if data.count > 0{
                    ...
                    vc.comeFrome = "MessgeOrganizationViewController"
...
extension MessgeOrganizationViewController2: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = MessgeOrganizationViewController3()
