//
//  CSSChatroomListViewController.m
//  NIM
//
...
#import "CSSChatroomListViewController.h"
#import "CSSMeetingViewController.h"
#import "CSSChatroomListCell.h"
#import "UIView+CSS.h"
...
@interface CSSChatroomListViewController ()
...
@implementation CSSChatroomListViewController
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[[NIMSDK sharedSDK] chatroomManager] enterChatroom:request
                                             completion:^(NSError *error,NIMChatroom *chatroom,NIMChatroomMember *me) {
                                                 ...
                                                 if (error == nil)
                                                 {
                                                     [[CSSMeetingManager sharedInstance] cacheMyInfo:me roomId:chatroom.roomId];
...
{
    CSSChatroomListCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ChatroomListReuseIdentity forIndexPath:indexPath];;
    NIMChatroom *chatroom = [self chatroomAtIndexPath:indexPath];
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[CSSChatroomListCell class] forCellWithReuseIdentifier:ChatroomListReuseIdentity];
