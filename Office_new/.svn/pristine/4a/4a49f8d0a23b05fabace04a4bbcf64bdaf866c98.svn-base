...
@interface CSTeamMemberCardViewController () <UITableViewDelegate, UITableViewDataSource,UIActionSheetDelegate>{
...
@property (strong, nonatomic) CSUsrInfo *usrInfo;

@end

@implementation CSTeamMemberCardViewController
...
- (void)viewDidLoad {
    ...
    CSUsrInfo *user = [[CSUsrInfo alloc] init];
    user.info = [[CSKit sharedKit] infoByUser:self.member.memberId];
    self.usrInfo = user;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (row) {
        case TeamMemberCardSectionHead: {
            ...
            CSAvatarImageView *avatarView = [[CSAvatarImageView alloc] initWithFrame:CGRectMake(125, 52, 70, 70)];
            ...
            nickLabel.text = [CSKitUtil showNick:self.member.memberId inSession:session];
            [nickLabel sizeToFit];
