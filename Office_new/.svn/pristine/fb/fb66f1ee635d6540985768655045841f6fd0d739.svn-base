...
#import "UIActionSheet+CSSBlock.h"
#import "CSSLogManager.h"
#import "CSSRegisterViewController.h"
#import "UIViewController+CSS.h"
#import "CSSEnterRoomViewController.h"
#import "CSSPageContext.h"

@interface CSSLoginViewController ()<CSSRegisterViewControllerDelegate>
...
@implementation CSSLoginViewController
    ...
    [[[NIMSDK sharedSDK] loginManager] login:loginAccount
                                  ...
                                  completion:^(NSError *error) {
                                      ...
                                      if (error == nil)
                                      {
                                          ...
                                          [[CSSLoginManager sharedManager] setCurrentNTESLoginData:sdkData];
                                          
                                          [[CSSServiceManager sharedManager] start];
...
#pragma mark - CSSRegisterViewControllerDelegate
...
#pragma mark - Private
- (void)showSDKLog{
    UIViewController *vc = [[CSSLogManager sharedManager] sdkLogViewController];
...
- (void)showDemoLog{
    UIViewController *logViewController = [[CSSLogManager sharedManager] demoLogViewController];
...
{
    CSSRegisterViewController *vc = [CSSRegisterViewController new];
    vc.delegate = self;
    [self.navigationController pushViewController:vc animated:YES];
}
