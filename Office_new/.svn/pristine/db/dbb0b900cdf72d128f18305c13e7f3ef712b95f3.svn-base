//
//  MineOrganizationViewController.swift
//  Office
//
...
class MineOrganizationViewController: BaseViewController {
...
extension MineOrganizationViewController:UITextFieldDelegate{
    func creatUI() {
...
extension MineOrganizationViewController: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = MineOrganizationViewController2()
        vc.model = self.dataSource[indexPath.row - 1]
        self.navigationController?.pushViewController(vc, animated: false)
    }
}
extension MineOrganizationViewController{
    func leftBtnClicked(){
