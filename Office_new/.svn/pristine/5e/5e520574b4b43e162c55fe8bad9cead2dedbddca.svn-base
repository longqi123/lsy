...
@interface CSSRegisterViewController ()

@end

@implementation CSSRegisterViewController
...
{
    CSSRegisterData *data = [[CSSRegisterData alloc] init];
    ...
    [[CSSDemoService sharedService] registerUser:data
