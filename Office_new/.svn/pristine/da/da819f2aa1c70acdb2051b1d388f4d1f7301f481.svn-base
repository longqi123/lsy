//
//  MineOrganizationViewController2.swift
//  Office
//
...
class MineOrganizationViewController2: UIViewController {
...
extension MineOrganizationViewController2:UITextFieldDelegate{
    func creatUI() {
        ...
        Network.post(parameter: para, success: { (json) in
            ...
            if json["result"]["Fenye"].count > 0{//跳转好友列表
                ...
                if data.count > 0{
                    ...
                    vc.comeFrome = "MineOrganizationViewController"
...
extension MineOrganizationViewController2: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.row == 0 {
            ...
            cell.title.text = "四川省地方税务局 - \(model.fullname)"
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = MineOrganizationViewController3()
...
extension MineOrganizationViewController2{
    func leftBtnClicked(){
