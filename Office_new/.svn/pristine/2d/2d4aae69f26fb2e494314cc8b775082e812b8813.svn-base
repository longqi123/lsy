...
@interface CSTeamCardOperationItem()

@property(nonatomic,assign) CSKitCardHeaderOpeator opera;

@end

@implementation CSTeamCardOperationItem

- (instancetype)initWithOperation:(CSKitCardHeaderOpeator)opera{
    self = [self init];
    if (self) {
...
- (void)buildWithTeamCardOperation:(CSKitCardHeaderOpeator)opera{
    _opera = opera;
    switch (opera) {
