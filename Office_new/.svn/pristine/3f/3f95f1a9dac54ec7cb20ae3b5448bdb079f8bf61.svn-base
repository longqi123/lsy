...
@interface CSSWhiteboardCommand : NSObject

+ (NSString *)pointCommand:(CSSWhiteboardPoint *)point;
...
+ (NSString *)docShareCommand:(CSSDocumentShareInfo *)shareInfo;
