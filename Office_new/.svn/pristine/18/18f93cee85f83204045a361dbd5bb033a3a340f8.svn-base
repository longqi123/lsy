...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        _imageView                  = [[NIMAvatarImageView alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
        ...
        _deleteImageView.image = [UIImage imageNamed:@"shan_chu_xiao_cha"];
...
- (void)layoutSubviews{
    ...
    [self.deleteImageView sizeToFit];
    self.deleteImageView.nim_top = self.imageView.nim_top;
    self.deleteImageView.nim_right  = self.imageView.nim_right;
