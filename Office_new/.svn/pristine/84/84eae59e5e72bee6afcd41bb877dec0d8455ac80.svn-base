//
//  AddMineOrganizationViewController3.swift
//  Office
//
...
import HandyJSON
import SwiftyJSON
class AddMineOrganizationViewController3: UIViewController {
    var isAll = false
...
extension AddMineOrganizationViewController3{
    func creatUI() {
        ...
        Network.post(parameter: para, success: { (json) in
            ...
            if json["result"]["Fenye"].count > 0{//跳转好友列表
                ...
                if data.count > 0{
                    ...
                    vc.comeFrome = "AddMineOrganizationViewController2"
...
extension AddMineOrganizationViewController3: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
            ...
            let vc = AddMineOrganizationViewController4()
