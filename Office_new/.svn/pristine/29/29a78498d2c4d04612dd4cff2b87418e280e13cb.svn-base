...
@implementation CSSDemoCreateMeetingTask
...
- (NSURLRequest *)taskRequest
{
    ...
    NSString *urlString = [[[CSSDemoConfig sharedConfig] apiURL] stringByAppendingString:@"/chatroom/create"];
