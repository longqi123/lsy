 ...
 *  消息对应的布局配置
 */
@property (nonatomic,strong) id<CSCellLayoutConfig> layoutConfig;

/**
 *  消息对应的session配置
 */
@property (nonatomic,strong) id<CSSessionConfig>  sessionConfig;
...
/**
 *  NIMMessage封装成CSMessageModel的方法
 *
 *  @param  message 消息体
 *
 *  @return CSMessageModel实例
 */
