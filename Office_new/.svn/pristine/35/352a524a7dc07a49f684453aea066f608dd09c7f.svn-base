...
@implementation CSSPinyinConverter
+ (CSSPinyinConverter *)sharedInstance
{
    static CSSPinyinConverter *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[CSSPinyinConverter alloc] init];
    });
    return instance;
}
