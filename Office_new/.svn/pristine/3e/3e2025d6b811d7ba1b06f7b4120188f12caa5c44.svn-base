...
@implementation CSSDemoCloseMeetingTask
...
- (NSURLRequest *)taskRequest
{
    ...
    NSString *urlString = [[[CSSDemoConfig sharedConfig] apiURL] stringByAppendingString:@"/chatroom/close"];
