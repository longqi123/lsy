//
//  MineOrganizationViewController3.swift
//  Office
//
...
import HandyJSON
import SwiftyJSON
class MineOrganizationViewController3: UIViewController {
...
extension MineOrganizationViewController3:UITextFieldDelegate{
    func creatUI() {
        ...
        Network.post(parameter: para, success: { (json) in
            ...
            if json["result"]["Fenye"].count > 0{//跳转好友列表
                ...
                if data.count > 0{
                    ...
                    vc.comeFrome = "MineOrganizationViewController2"
...
extension MineOrganizationViewController3: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let vc = MineOrganizationViewController4()
...
extension MineOrganizationViewController3{
    func leftBtnClicked(){
