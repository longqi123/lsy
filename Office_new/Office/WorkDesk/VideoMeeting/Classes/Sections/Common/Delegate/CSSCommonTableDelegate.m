...
@interface CSSCommonTableDelegate()

@property (nonatomic,copy) NSArray *(^NTESDataReceiver)(void);

@end

@implementation CSSCommonTableDelegate
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (![cell respondsToSelector:@selector(refreshData:tableView:)]) {
        ...
        [(id<CSSCommonTableViewCell>)cell refreshData:tableRow tableView:tableView];
    }
