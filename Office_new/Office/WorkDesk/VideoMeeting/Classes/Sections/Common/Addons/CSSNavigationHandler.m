...
#import "UIView+CSS.h"
#import "UIResponder+CSSFirstResponder.h"
#import "CSSNavigationAnimator.h"

@interface CSSNavigationHandler()<UIGestureRecognizerDelegate>

@property (nonatomic,strong) UIPercentDrivenInteractiveTransition* interaction;

@property (nonatomic,weak)   UINavigationController *navigationController;

@property (nonatomic,strong) CSSNavigationAnimator *animator;
...
@implementation CSSNavigationHandler
...
- (instancetype)initWithNavigationController:(UINavigationController *)navigationController
{
    ...
    if (self) {
        ...
        _animator = [[CSSNavigationAnimator alloc] initWithNavigationController:navigationController];
