...
@interface CSSColorSelectView()

@property (nonatomic, strong) NSArray *colors;
@property (nonatomic, strong) NSMutableArray <UIButton *> *selectButtons;
@property(nonatomic, weak) id<CSSColorSelectViewDelegate> delegate;

@end

@implementation CSSColorSelectView

- (instancetype)initWithFrame:(CGRect)frame
                       colors:(NSArray *)colors
                     delegate:(id<CSSColorSelectViewDelegate>)delegate
{
