...
@interface CSSVideoFSViewController ()
@property (nonatomic,strong)CSSGLView *videoView ;
@property (nonatomic,strong)UIButton *backBtn ;

@end

@implementation CSSVideoFSViewController
...
//    self.view.backgroundColor = [UIColor whiteColor];
    ...
    _videoView = [[CSSGLView alloc]initWithFrame:CGRectZero];
