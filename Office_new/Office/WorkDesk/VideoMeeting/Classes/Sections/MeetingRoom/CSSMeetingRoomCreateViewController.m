//
//  CSSMeetingRoomCreateViewController.m
//  NIMEducationDemo
//
...
@interface CSSMeetingRoomCreateViewController ()
...
@implementation CSSMeetingRoomCreateViewController
...
- (void)viewDidLoad {
    ...
    self.tableView.backgroundColor = UIColor.B2;
...
- (void)setUpNav{
    self.navigationItem.title = @"创建会议室";
...
- (void)requestChatRoom
{
    ...
    [[CSSDemoService sharedService] requestChatRoom:self.roomName
