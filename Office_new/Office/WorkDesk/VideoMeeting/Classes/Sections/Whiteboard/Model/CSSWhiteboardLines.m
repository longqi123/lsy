...
@implementation CSSWhiteboardLines
...
- (void)addPoint:(CSSWhiteboardPoint *)point uid:(NSString *)uid
{
    ...
    if (point.type == CSSWhiteboardPointTypeStart) {
...
#pragma  mark - CSSWhiteboardDrawViewDataSource
