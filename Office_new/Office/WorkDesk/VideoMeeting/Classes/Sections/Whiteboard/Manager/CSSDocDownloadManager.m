...
@interface CSSDocDownloadManager ()

@property(nonatomic, strong)NSMutableDictionary *docDic;
@property(nonatomic, strong)NSMutableArray *downloadTask;

@property (nonatomic,weak) id<CSSDocDownloadManagerDelegate> delegate;

@end

@implementation CSSDocDownloadManager

+ (instancetype)sharedManager
{
    static CSSDocDownloadManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[CSSDocDownloadManager alloc] init];
...
-(void)downLoadDoc:(NIMDocTranscodingInfo*)info
{
    ...
    NSString * filePathPrefix = [CSSDocumentHandler getFilePathPrefix:info.docId];
