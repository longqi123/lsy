...
@implementation CSSRegisterData
@end

@implementation CSSDemoRegisterTask
- (NSURLRequest *)taskRequest
{
    NSString *urlString = [[[CSSDemoConfig sharedConfig] apiURL] stringByAppendingString:@"/createDemoUser"];
