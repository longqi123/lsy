...
@class CSAttributedLabelURL;

@interface CSAttributedLabel : UIView
@property (nonatomic,weak)    id<CSAttributedLabelDelegate> delegate;
...
//设置全局的自定义Link检测Block(详见CSAttributedLabelURL)
