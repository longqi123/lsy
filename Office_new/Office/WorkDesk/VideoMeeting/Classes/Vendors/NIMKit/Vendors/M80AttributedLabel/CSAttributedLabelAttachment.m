...
{
    CSAttributedLabelAttachment *image = (__bridge CSAttributedLabelAttachment *)ref;
    CGFloat ascent = 0;
...
#pragma mark - CSAttributedLabelImage
@interface CSAttributedLabelAttachment ()
- (CGSize)calculateContentSize;
- (CGSize)attachmentSize;
@end

@implementation CSAttributedLabelAttachment




+ (CSAttributedLabelAttachment *)attachmentWith: (id)content
                                          margin: (UIEdgeInsets)margin
                                       alignment: (NIMImageAlignment)alignment
                                         maxSize: (CGSize)maxSize
{
    CSAttributedLabelAttachment *attachment    = [[CSAttributedLabelAttachment alloc]init];
