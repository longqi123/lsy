...
@interface CSSessionAudioContentView()<NIMMediaManagerDelgate>
...
@implementation CSSessionAudioContentView
...
- (void)addVoiceView{
    UIImage * image = [UIImage cs_imageInKit:@"icon_receiver_voice_playing.png"];
    ...
    for (NSString * animateName in animateNames) {
        UIImage * animateImage = [UIImage cs_imageInKit:animateName];
