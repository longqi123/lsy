...
@interface CSCreateTeamAnnouncement () <UITextFieldDelegate, UITextViewDelegate>
...
@implementation CSCreateTeamAnnouncement

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"新建群公告";
    self.view.backgroundColor = CSKit_UIColorFromRGB(0xe4e7ec);
