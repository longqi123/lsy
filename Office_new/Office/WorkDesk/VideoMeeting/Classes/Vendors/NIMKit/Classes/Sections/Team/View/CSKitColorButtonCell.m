...
@interface CSKitColorButtonCell()

@end

@implementation CSKitColorButtonCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        self.backgroundColor = [UIColor clearColor];
        _button = [[CSKitColorButton alloc] initWithFrame:CGRectZero];
...
@implementation CSKitColorButton : UIButton
...
- (void)setStyle:(CSKitColorButtonCellStyle)style{
    _style = style;
    [self reset];
}
...
- (void)reset{
    ...
    switch (self.style) {
        case CSKitColorButtonCellStyleRed:
            imageNormalName = @"icon_cell_red_normal";
            imageHighLightName  = @"icon_cell_red_pressed";
            break;
        case CSKitColorButtonCellStyleBlue:
