...
open class ImageSlideshow: UIView {
    ...
    override open func layoutSubviews() {
        ...
        pageControl.frame = CGRect(x: frame.size.width - frame.size.width/4, y: frame.size.height - 30, width: frame.size.width/4, height: 30)
//        pageControl.center = CGPoint(x: frame.size.width * 4 / 5, y: frame.size.height - 12.0)
